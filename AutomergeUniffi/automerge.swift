    ...
    DocProtocol
{
    ...
    open func splice(obj: ObjId, start: UInt64, deleteCount: Int64, values: [ScalarValue]) throws {
        try rustCallWithError(FfiConverterTypeDocError.lift) {
    ...
    open func spliceText(obj: ObjId, start: UInt64, deleteCount: Int64, chars: String) throws {
        try rustCallWithError(FfiConverterTypeDocError.lift) {
